 ...
 * File		   : IDirect3DDevice9ProxyEx.h
 * Developers  : RootKiller <rootkiller.programmer@gmail.com>
 *
 ***************************************************************/
#pragma once
#ifndef IDIRECT3DDEVICE9PROXYEX_H
#define IDIRECT3DDEVICE9PROXYEX_H

interface IDirect3DDevice9ProxyEx : public IDirect3DDevice9Ex
{
private:
	IDirect3DDevice9Ex *m_pDevice;
public:
	IDirect3DDevice9ProxyEx(IDirect3DDevice9Ex * pDevice);
